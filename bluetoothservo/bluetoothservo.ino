...
void setup() {
  ...
  angle1=10;//map(analogRead(A1),0,1023,0,180);
}

void loop() {
//  inangle=map(analogRead(A1),0,1023,0,180);
  //if (abs(angle1-inangle)>3){// if there is any changes it starts to work, 1 degree is taken to avoid noise level
